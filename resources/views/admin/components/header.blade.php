            ...
            <li class="dropdown pull-right" style="margin-right: 30px !important">
                ...
                <ul class="dropdown-menu animated m-t-xs">
                    <li><a class="animated animated-short fadeInUp" data-toggle="modal"
                            data-target="#change_password_dashboard_account_Modal">Đổi mật khẩu</a></li>
                    <li class="divider"></li>
                    <li><a class="animated animated-short fadeInUp" data-toggle="modal" data-target="#profile_account_Modal">Thông tin
                            tài khoản</a></li>
                    <li class="divider"></li>
                    <li><a href="#" class="animated animated-short fadeInUp" data-toggle="modal" data-target="#logout-dasboard"><i
